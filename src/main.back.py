...
# bh.deploy_contracts()
# print(bh.deposit_to_wallet(100))
...
# curl http://127.0.0.1:5000/ethbalance/0x57C75A6B1EE0F9698386B9FE674A7B3Eb45E9A4B
@app.route('/ethbalance/<string:address>')
def eth_balance(address):
    eth_balance = bh.get_balance(address)
